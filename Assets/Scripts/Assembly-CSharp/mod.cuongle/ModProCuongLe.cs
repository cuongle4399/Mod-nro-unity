...
namespace Mod.CuongLe
{
    public class ModProCuongLe : IActionListener
    {
        ...
        public static bool MuaBinhHutNangLuongNe;
        ...
        public static void ShowMenu()
        {
            ...
            myVector.addElement(new Command("Auto mua bình hút: " + (MuaBinhHutNangLuongNe ? "Bật" : "Tắt"), getInstance(), 12, null));
        ...
        public void perform(int idAction, object p)
        {
            switch (idAction)
            {
                ...
                case 10:
                    ...
                    break;
                case 12:
                    MuaBinhHutNangLuongNe = !MuaBinhHutNangLuongNe;
                    if (MuaBinhHutNangLuongNe)
                    {

                        new Thread(MuaBinhHutNangLuong).Start();
                    }
                    break;
                case 16:
                    {
        ...
        public static void useItem(int x)
        {
            ...
            {
                if (Char.myCharz().arrItemBag[b].template.id == x)
                {
        ...
        public static void MuaBinhHutNangLuong()
        {

            if (!ModProCuongLe.ExistItemBag(1852))
            {
                ChatPopup.addChatPopupMultiLineGameline("Bạn chưa có bình hút ?", 0, null, 1);
                MuaBinhHutNangLuongNe = false;
                return;
            }
            if (Char.myCharz().luong < 5 && Char.myCharz().luongKhoa < 5)
            {
                ChatPopup.addChatPopupMultiLineGameline("Không có ngọc mua cc à ?", 0, null, 1);
                MuaBinhHutNangLuongNe = false;
                return;
            }
            if (TileMap.mapID != 181)
            {
                ChatPopup.addChatPopupMultiLineGameline("Zo map up rồi hãy bật nhé", 0, null, 1);
                MuaBinhHutNangLuongNe = false;
                return;
            }
            while (MuaBinhHutNangLuongNe)
            {
                if (!ModProCuongLe.checkItemTime(15359))
                {
                    AutoTrain.getInstance().perform(8, null);
                    Thread.Sleep(1000);
                    ModProCuongLe.teleNPC(44);
                    Service.gI().openMenu(44);
                    Service.gI().confirmMenu(44, 1);
                    Service.gI().confirmMenu(44, 0);
                    GameCanvas.menu.performSelect();
                    GameCanvas.menu.doCloseMenu();
