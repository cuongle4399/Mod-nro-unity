...
public class Panel : IActionListener, IChatable
{
    ...
    private void doFireModTabs()
    {
        ...
        {
            case 0:
                DoHoa.HienThiLogo = !DoHoa.HienThiLogo;
                Rms.saveRMSInt("saveLogo", DoHoa.HienThiLogo ? 1 : 0);
                break;
            case 1:
                DoHoa.HienThiBackground = !DoHoa.HienThiBackground;
                Rms.saveRMSInt("saveBackground", DoHoa.HienThiBackground ? 1 : 0);
                break;
            case 2:
