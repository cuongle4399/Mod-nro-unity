public class T2 : mResources
{
	public static void load()
	{
		...
		mResources.finishBomong = "You must finish the mission find 6 star dragon to recharge";
		...
		mResources.alreadyHadAccount1 = "Did you already play and own a Dragon Online's account at server ";
		...
		mResources.acc = "Acc";
		mResources.pwd = "Pwd";
		mResources.goToWebForPassword = "To recover password, please visit website http://abc.com";
