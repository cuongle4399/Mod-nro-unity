public class T3 : mResources
{
	public static void load()
	{
		...
		mResources.finishBomong = "Kamu harus menyelesaikan misi mencari Dragon bintang 6 untuk recharge";
		...
		mResources.alreadyHadAccount1 = "Apakah kamu telah bermain dan memiliki account pada server Dragon Online sebelumnya?";
		...
		mResources.acc = "Acc";
		mResources.pwd = "Pwd";
		mResources.goToWebForPassword = "Untuk me-recover password harap kunjungi website http://abc.com";
		mResources.dragon_ball = "Dragon";
